    ...
    <div class="row">
        <div class="col-12 col-lg-4 col-xl-3">
            <form method="GET" class="d-flex flex-column mb-4">
                ...
                <!-- Filtrar -->
                <button type="submit" class="btn btn-kitchenpro btn-warning mt-2">Filtrar</button>
            </form>
        </div>
                        ...
                        <div class="col-12 col-md-4 col-xl-4 mb-4">
                            <div class="card h-100 shadow-sm">
                                ...
                                <div class="card-footer" style="border-top: none; background: none;">
                                    ...
                                    <a href="index.php?section=detalle&id=<?= $producto->getId() ?>" class="btn btn-kitchenpro btn-warning w-100">Ver más</a>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; ?>
